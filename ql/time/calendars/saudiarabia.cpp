...
namespace QuantLib
{
    ...
    namespace
    {
        ...
        bool isTrueWeekend(Date d)
        {
            ...
            Weekday w = d.weekday();
            return (d < Date(29, June, 2013)) ? (w == Thursday || w == Friday) : (w == Friday || w == Saturday);
        }
        ...
        bool isEidAlAdha(Date d)
        {
            ...
            static std::vector<Date> EidAlAdha = {
                Date(7, April, 1998),      Date(27, March, 1999),     Date(16, March, 2000),
                Date(5, March, 2001),      Date(23, February, 2002),  Date(12, February, 2003),
                Date(1, February, 2004),   Date(21, January, 2005),   Date(10, January, 2006),
                Date(31, December, 2006),  Date(20, December, 2007),  Date(8, December, 2008),
                Date(27, November, 2009),  Date(16, November, 2010),  Date(6, November, 2011),
                Date(26, October, 2012),   Date(15, October, 2013),   Date(4, October, 2014),
                Date(24, September, 2015), Date(11, September, 2016), Date(1, September, 2017),
                Date(23, August, 2018),    Date(12, August, 2019),    Date(31, July, 2020),
                Date(20, July, 2021),      Date(10, July, 2022)};

            return std::any_of(EidAlAdha.begin(), EidAlAdha.end(), [=](Date p) { return d >= p - 1 && d <= p + 4; });
        }
        ...
        bool isEidAlFitr(Date d)
        {
            ...
            static std::vector<Date> EidAlFitr = {
                Date(16, Dec, 2001), Date(5, Dec, 2002),  Date(25, Nov, 2003), Date(13, Nov, 2004), Date(3, Nov, 2005),
                Date(23, Oct, 2006), Date(12, Oct, 2007), Date(30, Sep, 2008), Date(20, Sep, 2009), Date(10, Sep, 2010),
                Date(30, Aug, 2011), Date(19, Aug, 2012), Date(8, Aug, 2013),  Date(28, Jul, 2014), Date(17, Jul, 2015),
                Date(6, Jul, 2016),  Date(25, Jun, 2017), Date(15, Jun, 2018), Date(4, Jun, 2019),  Date(24, May, 2020),
                Date(13, May, 2021), Date(2, May, 2022),  Date(21, Apr, 2023), Date(10, Apr, 2024), Date(30, Mar, 2025),
                Date(20, Mar, 2026), Date(9, Mar, 2027),  Date(26, Feb, 2028), Date(14, Feb, 2029)};

            return std::any_of(EidAlFitr.begin(), EidAlFitr.end(), [=](Date p) { return d >= p - 1 && d <= p + 4; });
        }
    ...
    SaudiArabia::SaudiArabia(Market market)
    {
        ...
        static ext::shared_ptr<Calendar::Impl> tadawulImpl(new SaudiArabia::TadawulImpl);
        switch (market)
        {
            case Tadawul:
                impl_ = tadawulImpl;
