...
namespace QuantLib
{
    ...
    bool NewZealand::CommonImpl::isBusinessDay(const Date& date) const
    {
        ...
        if (isWeekend(w)
            ...
            // next 30 years
            || (d == 20 && m == June && y == 2025) || (d == 21 && m == June && (y == 2030 || y == 2052)) ||
            (d == 24 && m == June && (y == 2022 || y == 2033 || y == 2044)) ||
            (d == 25 && m == June && (y == 2027 || y == 2038 || y == 2049)) || (d == 28 && m == June && y == 2024) ||
            (d == 29 && m == June && (y == 2035 || y == 2046)) || (d == 30 && m == June && y == 2051) ||
            (d == 2 && m == July && y == 2032) || (d == 3 && m == July && (y == 2043 || y == 2048)) ||
            (d == 6 && m == July && (y == 2029 || y == 2040)) || (d == 7 && m == July && (y == 2034 || y == 2045)) ||
            (d == 10 && m == July && (y == 2026 || y == 2037)) || (d == 11 && m == July && (y == 2031 || y == 2042)) ||
            (d == 14 && m == July && (y == 2023 || y == 2028)) || (d == 15 && m == July && (y == 2039 || y == 2050)) ||
            (d == 18 && m == July && y == 2036) ||
    ...
    bool NewZealand::AucklandImpl::isBusinessDay(const Date& date) const
    {
        ...
        if ((d >= 26 && w == Monday && m == January) || (d == 1 && w == Monday && m == February))
            return false; // NOLINT(readability-simplify-boolean-expr)
        return true;
    }
