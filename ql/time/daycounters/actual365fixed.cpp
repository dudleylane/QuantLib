...
namespace QuantLib
{
    ...
    ext::shared_ptr<DayCounter::Impl> Actual365Fixed::implementation(Actual365Fixed::Convention c)
    {
        switch (c)
        {
            case Standard:
                                               ...
                                               const Date& refPeriodEnd) const
    {
        ...
        QL_REQUIRE(frequency != 0, "invalid reference period for Act/365 Canadian; "
    ...
    Date::serial_type Actual365Fixed::NL_Impl::dayCount(const Date& d1, const Date& d2) const
    {
    ...
    Time Actual365Fixed::NL_Impl::yearFraction(const Date& d1, const Date& d2, const Date& d3, const Date& d4) const
    {
