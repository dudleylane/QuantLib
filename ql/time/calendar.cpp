...
namespace QuantLib
{
    ...
    namespace
    {
        ...
        // Requires: from < to.
        Date::serial_type
        daysBetweenImpl(const Calendar& cal, const Date& from, const Date& to, bool includeFirst, bool includeLast)
        {
    ...
    Date::serial_type
    Calendar::businessDaysBetween(const Date& from, const Date& to, bool includeFirst, bool includeLast) const
    {
    ...
    std::vector<Date> Calendar::holidayList(const Date& from, const Date& to, bool includeWeekEnds) const
    {
    ...
    std::vector<Date> Calendar::businessDayList(const Date& from, const Date& to) const
    {
