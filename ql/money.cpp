...
namespace QuantLib
{
    ...
    namespace
    {
        ...
        {
            const auto& base_currency = Money::Settings::instance().baseCurrency();
    ...
    {
        return apply<Decimal>(m1, m2, [](const Real x, const Real y) { return x / y; });
    }

    bool operator==(const Money& m1, const Money& m2)
    {
        return apply<bool>(m1, m2, [](const Real x, const Real y) { return x == y; });
    }
    ...
    {
        return apply<bool>(m1, m2, [n](const Real x, const Real y) { return close(x, y, n); });
    }

    bool close_enough(const Money& m1, const Money& m2, Size n)
    {
        return apply<bool>(m1, m2, [n](const Real x, const Real y) { return close_enough(x, y, n); });
    }
