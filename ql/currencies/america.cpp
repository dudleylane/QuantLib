...
namespace QuantLib
{
    ...
    */
    ...
    {
        static auto ttdData =
            ext::make_shared<Data>("Trinidad & Tobago dollar", "TTD", 780, "TT$", "", 100, Rounding());
        data_ = ttdData;
    }
    ...
    */
    ...
    {
        static auto mxvData =
            ext::make_shared<Data>("Mexican Unidad de Inversion", "MXV", 979, "MXV", "", 1, Rounding());
        data_ = mxvData;
    }
    ...
    {
        static auto couData =
            ext::make_shared<Data>("Unidad de Valor Real (UVR) (funds code)", "COU", 970, "COU", "", 100, Rounding());
        data_ = couData;
    }
    ...
    {
        static auto clfData =
            ext::make_shared<Data>("Unidad de Fomento (funds code)", "CLF", 990, "CLF", "", 1, Rounding());
        data_ = clfData;
    }
