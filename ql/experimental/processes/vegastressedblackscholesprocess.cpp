...
namespace QuantLib
{
    ...
    VegaStressedBlackScholesProcess::VegaStressedBlackScholesProcess(const Handle<Quote>& x0,
    ...
    : GeneralizedBlackScholesProcess(x0, dividendTS, riskFreeTS, blackVolTS, disc),
      ...
      upperAssetBorderForStressTest_(upperAssetBorderForStressTest), stressLevel_(stressLevel)
    {
    }
