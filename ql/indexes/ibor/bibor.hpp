...
namespace QuantLib
{
    ...
    {
      public:
        explicit BiborSW(const Handle<YieldTermStructure>& h = {}) : Bibor(Period(1, Weeks), h) {}
    };
    ...
    {
      public:
        explicit Bibor1M(const Handle<YieldTermStructure>& h = {}) : Bibor(Period(1, Months), h) {}
    };
    ...
    {
      public:
        explicit Bibor2M(const Handle<YieldTermStructure>& h = {}) : Bibor(Period(2, Months), h) {}
    };
    ...
    {
      public:
        explicit Bibor3M(const Handle<YieldTermStructure>& h = {}) : Bibor(Period(3, Months), h) {}
    };
    ...
    {
      public:
        explicit Bibor6M(const Handle<YieldTermStructure>& h = {}) : Bibor(Period(6, Months), h) {}
    };
    ...
    {
      public:
        explicit Bibor1Y(const Handle<YieldTermStructure>& h = {}) : Bibor(Period(1, Years), h) {}
    };
