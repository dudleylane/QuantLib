...
namespace QuantLib
{
    ...
    ext::shared_ptr<SmileSection> InterpolatedSwaptionVolatilityCube::smileSectionImpl(Time optionTime,
    ...
    ext::shared_ptr<SmileSection> InterpolatedSwaptionVolatilityCube::smileSectionImpl(const Date& optionDate,
                                                                                       const Period& swapTenor) const
    {
        ...
        return ext::shared_ptr<SmileSection>(new InterpolatedSmileSection<Linear>(
