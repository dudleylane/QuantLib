...
namespace QuantLib
{
    ...
    OptionletStripper::OptionletStripper(const ext::shared_ptr<CapFloorTermVolSurface>& termVolSurface,
                                         ext::shared_ptr<IborIndex> iborIndex,
                                         Handle<YieldTermStructure> discount,
                                         const VolatilityType type,
                                         const Real displacement,
                                         ext::optional<Period> optionletFrequency)
    : termVolSurface_(termVolSurface), iborIndex_(std::move(iborIndex)), discount_(std::move(discount)),
      ...
      optionletFrequency_(optionletFrequency)
    {
        ...
        {
            QL_REQUIRE(optionletFrequency_, "an optionlet frequency is required when using an overnight index");
        }
    ...
    ext::shared_ptr<CapFloorTermVolSurface> OptionletStripper::termVolSurface() const
    {
