...
namespace QuantLib
{
    ...
    StrippedOptionletAdapter::StrippedOptionletAdapter(const ext::shared_ptr<StrippedOptionletBase>& s)
    ...
    ext::shared_ptr<SmileSection> StrippedOptionletAdapter::smileSectionImpl(Time t) const
    {
    ...
    Volatility StrippedOptionletAdapter::volatilityImpl(Time length, Rate strike) const
    {
        calculate();
    ...
    void StrippedOptionletAdapter::performCalculations() const
    {
        ...
        for (Size i = 0; i < nInterpolations_; ++i)
        {
            ...
            //                               //optMethod_
            //                               ));
            strikeInterpolations_[i] = ext::make_shared<LinearInterpolation>(
