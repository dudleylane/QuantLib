...
namespace QuantLib
{
    ...
    YoYOptionletVolatilitySurface::YoYOptionletVolatilitySurface(Natural settlementDays,
                                                                 const Calendar& cal,
                                                                 ...
                                                                 Real displacement)
    : VolatilityTermStructure(settlementDays, cal, bdc, dc), baseLevel_(Null<Volatility>()),
    ...
    Date YoYOptionletVolatilitySurface::baseDate() const
    {
    ...
    void YoYOptionletVolatilitySurface::checkRange(const Date& d, Rate strike, bool extrapolate) const
    {
        ...
        QL_REQUIRE(extrapolate || allowsExtrapolation() || (strike >= minStrike() && strike <= maxStrike()),
                   "strike (" << strike << ") is outside the curve domain [" << minStrike() << "," << maxStrike()
                              << "]] at date = " << d);
    }


    void YoYOptionletVolatilitySurface::checkRange(Time t, Rate strike, bool extrapolate) const
    {
    ...
    Volatility YoYOptionletVolatilitySurface::volatility(const Date& maturityDate,
                                                         Rate strike,
                                                         const Period& obsLag,
    ...
    Volatility YoYOptionletVolatilitySurface::volatility(const Period& optionTenor,
                                                         Rate strike,
                                                         const Period& obsLag,
                                                         bool extrapolate) const
    {
    ...
    Time YoYOptionletVolatilitySurface::timeFromBase(const Date& maturityDate, const Period& obsLag) const
    {
        ...
        {
            useDate = inflationPeriod(maturityDate - useLag, frequency()).first;
        }
    ...
    Volatility YoYOptionletVolatilitySurface::totalVariance(const Date& maturityDate,
                                                            Rate strike,
                                                            const Period& obsLag,
                                                            bool extrapolate) const
    {
    ...
    Volatility YoYOptionletVolatilitySurface::totalVariance(const Period& tenor,
                                                            Rate strike,
                                                            const Period& obsLag,
                                                            bool extrap) const
    {
    ...
    ConstantYoYOptionletVolatility::ConstantYoYOptionletVolatility(const Volatility v,
    ...
    : YoYOptionletVolatilitySurface(
          settlementDays, cal, bdc, dc, observationLag, frequency, indexIsInterpolated, volType, displacement),
