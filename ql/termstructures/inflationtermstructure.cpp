...
namespace QuantLib
{
    ...
    InflationTermStructure::InflationTermStructure(Date baseDate,
                                                   Frequency frequency,
                                                   const DayCounter& dayCounter,
                                                   ext::shared_ptr<Seasonality> seasonality,
                                                   Rate baseRate)
    : TermStructure(dayCounter), seasonality_(std::move(seasonality)), frequency_(frequency), baseRate_(baseRate),
      baseDate_(baseDate)
    {
        if (seasonality_ != nullptr)
        {
            QL_REQUIRE(seasonality_->isConsistent(*this), "Seasonality inconsistent with inflation term structure");
        }
    }
    ...
    InflationTermStructure::InflationTermStructure(const Date& referenceDate,
                                                   ...
                                                   ext::shared_ptr<Seasonality> seasonality,
                                                   Rate baseRate)
    : TermStructure(referenceDate, Calendar(), dayCounter), seasonality_(std::move(seasonality)), frequency_(frequency),
      baseRate_(baseRate), baseDate_(baseDate)
    {
        if (seasonality_ != nullptr)
        {
            QL_REQUIRE(seasonality_->isConsistent(*this), "Seasonality inconsistent with inflation term structure");
    ...
    InflationTermStructure::InflationTermStructure(Natural settlementDays,
                                                   ...
                                                   ext::shared_ptr<Seasonality> seasonality,
                                                   Rate baseRate)
    : TermStructure(settlementDays, calendar, dayCounter), seasonality_(std::move(seasonality)), frequency_(frequency),
      baseRate_(baseRate), baseDate_(baseDate)
    {
        if (seasonality_ != nullptr)
        {
    ...
    void InflationTermStructure::setSeasonality(const ext::shared_ptr<Seasonality>& seasonality)
    {
    ...
    ZeroInflationTermStructure::ZeroInflationTermStructure(Date baseDate,
                                                           Frequency frequency,
                                                           const DayCounter& dayCounter,
    ...
    ZeroInflationTermStructure::ZeroInflationTermStructure(const Date& referenceDate,
                                                           Date baseDate,
                                                           Frequency frequency,
                                                           const DayCounter& dayCounter,
                                                           const ext::shared_ptr<Seasonality>& seasonality)
    ...
    ZeroInflationTermStructure::ZeroInflationTermStructure(Natural settlementDays,
                                                           const Calendar& calendar,
                                                           Date baseDate,
                                                           Frequency frequency,
                                                           const DayCounter& dayCounter,
    ...
    Rate ZeroInflationTermStructure::zeroRate(Time t, bool extrapolate) const
    {
    ...
    YoYInflationTermStructure::YoYInflationTermStructure(Date baseDate,
                                                         Rate baseYoYRate,
                                                         Frequency frequency,
                                                         const DayCounter& dayCounter,
                                                         const ext::shared_ptr<Seasonality>& seasonality)
    ...
    YoYInflationTermStructure::YoYInflationTermStructure(const Date& referenceDate,
                                                         Date baseDate,
                                                         Rate baseYoYRate,
                                                         Frequency frequency,
                                                         const DayCounter& dayCounter,
    ...
    YoYInflationTermStructure::YoYInflationTermStructure(Natural settlementDays,
                                                         const Calendar& calendar,
                                                         Date baseDate,
                                                         Rate baseYoYRate,
                                                         Frequency frequency,
    ...
    Rate YoYInflationTermStructure::yoyRate(Time t, bool extrapolate) const
    {
        checkRange(t, extrapolate);
    ...
    Time inflationYearFraction(
        Frequency f, bool indexIsInterpolated, const DayCounter& dayCounter, const Date& d1, const Date& d2)
    {
