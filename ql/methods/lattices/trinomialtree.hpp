...
namespace QuantLib
{
    ...
    */
    ...
    inline Size TrinomialTree::descendant(Size i, Size index, Size branch) const
    {
    ...
    : probs_(3), kMin_(QL_MAX_INTEGER), jMin_(QL_MAX_INTEGER), kMax_(QL_MIN_INTEGER), jMax_(QL_MIN_INTEGER)
    {
    }

    inline Size TrinomialTree::Branching::descendant(Size index, Size branch) const
    {
        return k_[index] - jMin_ - 1 + branch;
    }

    inline Real TrinomialTree::Branching::probability(Size index, Size branch) const
    {
    ...
    inline void TrinomialTree::Branching::add(Integer k, Real p1, Real p2, Real p3)
    {
        // store
        k_.push_back(k);
