...
namespace QuantLib
{
    ...
    namespace
    {
        ...
        {
          public:
            explicit MultiDimFct(VF_R b) : b_(std::move(b)) { QL_REQUIRE(!b_.empty(), "zero size basis"); }
    ...
    VF_A LsmBasisSystem::multiPathBasisSystem(Size dim, Size order, PolynomialType type)
    {
