...
namespace QuantLib
{
    ...
    FdmBlackScholesFwdOp::FdmBlackScholesFwdOp(const ext::shared_ptr<FdmMesher>& mesher,
    ...
    Array FdmBlackScholesFwdOp::apply_direction(Size direction, const Array& r) const
    {
    ...
    Array FdmBlackScholesFwdOp::solve_splitting(Size direction, const Array& r, Real dt) const
    {
        if (direction == direction_)
    ...
    Array FdmBlackScholesFwdOp::preconditioner(const Array& r, Real dt) const
    {
