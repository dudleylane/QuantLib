...
namespace QuantLib
{
    ...
    */
    class [[deprecated("Part of the old FD framework; copy this function in your codebase if needed")]] DPlusDMinus
    : public TridiagonalOperator
    {
      public:
        DPlusDMinus(Size gridPoints, Real h) : TridiagonalOperator(gridPoints)
        {
