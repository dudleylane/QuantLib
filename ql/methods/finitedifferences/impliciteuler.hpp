...
namespace QuantLib
{
    ...
    */
    ...
    class [[deprecated("Part of the old FD framework; copy this function in your codebase if needed")]] ImplicitEuler
    : public MixedScheme<Operator>
    {
      public:
        ...
        // constructors
        ImplicitEuler(const operator_type& L, const bc_set& bcs) : MixedScheme<Operator>(L, 1.0, bcs) {}
    };
