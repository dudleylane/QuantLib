...
namespace QuantLib
{
    ...
    void Fdm2DimSolver::performCalculations() const
    {
        ...
        interpolation_ = ext::make_shared<BicubicSpline>(x_.begin(), x_.end(), y_.begin(), y_.end(), resultValues_);
    }
    ...
    Real Fdm2DimSolver::thetaAt(Real x, Real y) const
    {
        ...
        return (BicubicSpline(x_.begin(), x_.end(), y_.begin(), y_.end(), thetaValues)(x, y) - interpolateAt(x, y)) /
