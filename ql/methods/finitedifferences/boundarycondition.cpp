...
namespace QuantLib
{
    ...
    NeumannBC::NeumannBC(Real value, NeumannBC::Side side) : value_(value), side_(side) {}
    ...
    DirichletBC::DirichletBC(Real value, DirichletBC::Side side) : value_(value), side_(side) {}
