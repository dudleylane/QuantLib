...
namespace QuantLib
{
    ...
    class AnalyticDiscreteGeometricAveragePriceAsianHestonEngine::Integrand
    {
      ...
      public:
        Integrand(Real t,
                  ...
                  Real xiRightLimit)
        : t_(t), T_(T), K_(K), logK_(std::log(K)), kStar_(kStar), t_n_(std::move(t_n)), tauK_(std::move(tauK)),
    ...
    std::complex<Real> AnalyticDiscreteGeometricAveragePriceAsianHestonEngine::F(const std::complex<Real>& z1,
    ...
    std::complex<Real> AnalyticDiscreteGeometricAveragePriceAsianHestonEngine::F_tilde(const std::complex<Real>& z1,
                                                                                       const std::complex<Real>& z2,
                                                                                       Time tau) const
    {
        std::complex<Real> temp = std::sqrt(kappa_ * kappa_ - 2.0 * z1 * sigma_ * sigma_);
    ...
    std::complex<Real> AnalyticDiscreteGeometricAveragePriceAsianHestonEngine::z(const std::complex<Real>& s,
    ...
    std::complex<Real> AnalyticDiscreteGeometricAveragePriceAsianHestonEngine::a(const std::complex<Real>& s,
                                                                                 const std::complex<Real>& w,
                                                                                 Time t,
                                                                                 Time T,
                                                                                 Size kStar,
    ...
    std::complex<Real>
    AnalyticDiscreteGeometricAveragePriceAsianHestonEngine::omega_tilde(const std::complex<Real>& s,
                                                                        const std::complex<Real>& w,
                                                                        Size k,
                                                                        Size kStar,
                                                                        Size n,
    ...
    std::complex<Real> AnalyticDiscreteGeometricAveragePriceAsianHestonEngine::Phi(const std::complex<Real> s,
                                                                                   const std::complex<Real> w,
                                                                                   Time t,
                                                                                   Time T,
                                                                                   Size kStar,
    ...
    void AnalyticDiscreteGeometricAveragePriceAsianHestonEngine::calculate() const
    {
        ...
        */
        ...
        for (Real fixingTime : fixingTimes)
        {
            ...
            {
                tkr_tk_.push_back(
                    -std::log(riskFreeRate_->discount(fixingTime) / dividendYield_->discount(fixingTime)));
            }
        }
