...
namespace QuantLib
{
    ...
    FdG2SwaptionEngine::FdG2SwaptionEngine(const ext::shared_ptr<G2>& model,
                                           Size tGrid,
                                           Size xGrid,
                                           Size yGrid,
                                           Size dampingSteps,
    ...
    : GenericModelEngine<G2, Swaption::arguments, Swaption::results>(model), tGrid_(tGrid), xGrid_(xGrid),
      yGrid_(yGrid), dampingSteps_(dampingSteps), invEps_(invEps), schemeDesc_(schemeDesc)
    {
    }
    ...
    void FdG2SwaptionEngine::calculate() const
    {
        ...
        const ext::shared_ptr<FdmMesher> mesher(new FdmMesherComposite(xMesher, yMesher));
        ...
        const ext::shared_ptr<FdmInnerValueCalculator> calculator(
            new FdmAffineModelSwapInnerValue<G2>(model_.currentLink(), fwdModel, arguments_.swap, t2d, mesher, 0));
