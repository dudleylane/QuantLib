...
namespace QuantLib
{
    ...
    DiscountFactor AnalyticContinuousFixedLookbackEngine::riskFreeDiscount() const
    {
    ...
    DiscountFactor AnalyticContinuousFixedLookbackEngine::dividendDiscount() const
    {
    ...
    Real AnalyticContinuousFixedLookbackEngine::A(Real eta) const
    {
        ...
        Real d1 = std::log(ss) / stdDeviation() + 0.5 * (lambda + 1.0) * stdDeviation();
        Real N1 = f_(eta * d1);
