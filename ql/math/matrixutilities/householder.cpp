...
namespace QuantLib
{
    ...
    HouseholderTransformation::HouseholderTransformation(Array v) : v_(std::move(v)) {}
    ...
    HouseholderReflection::HouseholderReflection(Array e) : e_(std::move(e)) {}
    ...
    Array HouseholderReflection::reflectionVector(const Array& a) const
    {
        ...
        else if (eps < 1e-4)
        {
            ...
            const Array v = (a2 - a1 * (eps / 2.0 - eps2 / 8.0 + eps3 / 16.0 - 5 / 128.0 * eps4)) /
