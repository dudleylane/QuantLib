...
namespace QuantLib
{
    ...
    MarshallOlkinCopula::MarshallOlkinCopula(Real a1, Real a2) : a1_(1.0 - a1), a2_(1.0 - a2)
    {
        QL_REQUIRE(a1 >= 0.0, "1st parameter (" << a1 << ") must be non-negative");
        QL_REQUIRE(a2 >= 0.0, "2nd parameter (" << a2 << ") must be non-negative");
    }
