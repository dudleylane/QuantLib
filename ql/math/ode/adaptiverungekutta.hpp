...
namespace QuantLib
{
    ...
    class AdaptiveRungeKutta
    {
      public:
        ...
        */
        ...
        : eps_(eps), h1_(h1), hmin_(hmin), b31(3.0 / 40.0), b32(9.0 / 40.0), b51(-11.0 / 54.0), b53(-70.0 / 27.0),
          b54(35.0 / 27.0), b61(1631.0 / 55296.0), b62(175.0 / 512.0), b63(575.0 / 13824.0), b64(44275.0 / 110592.0),
          b65(253.0 / 4096.0), c1(37.0 / 378.0), c3(250.0 / 621.0), c4(125.0 / 594.0), c6(512.0 / 1771.0),
          dc1(c1 - 2825.0 / 27648.0), dc3(c3 - 18575.0 / 48384.0), dc4(c4 - 13525.0 / 55296.0), dc5(-277.0 / 14336.0),
          dc6(c6 - 0.25)
        {
        }
      ...
      private:
        ...
        const Real a2 = 0.2, a3 = 0.3, a4 = 0.6, a5 = 1.0, a6 = 0.875, b21 = 0.2, b31, b32, b41 = 0.3, b42 = -0.9,
                   b43 = 1.2, b51, b52 = 2.5, b53, b54, b61, b62, b63, b64, b65, c1, c3, c4, c6, dc1, dc3, dc4, dc5,
                   dc6;
    ...
    template <class T>
    std::vector<T>
    AdaptiveRungeKutta<T>::operator()(const OdeFct& ode, const std::vector<T>& y1, const Real x1, const Real x2)
    {
        Size n = y1.size();
        std::vector<T> y(y1);
    ...
    namespace detail
    {
        ...
        struct OdeFctWrapper
        {
            ...
            explicit OdeFctWrapper(const OdeFct1d& ode1d) : ode1d_(ode1d) {}
    ...
    template <class T>
    T AdaptiveRungeKutta<T>::operator()(const OdeFct1d& ode, const T y1, const Real x1, const Real x2)
    {
        return operator()(detail::OdeFctWrapper<T>(ode), std::vector<T>(1, y1), x1, x2)[0];
    }
                                     ...
                                     const OdeFct& derivs)
    {
        ...
        for (;;)
        {
            ...
            if (errmax > 1.0)
            {
                ...
                xnew = x + h;
                if (xnew == x)
                    QL_FAIL("Stepsize underflow (" << h << " at x = " << x << ") in AdaptiveRungeKutta::rkqs");
                continue;
            }
            else
            {
