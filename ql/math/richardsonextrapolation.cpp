...
namespace QuantLib
{
    namespace
    {
        ...
        {
          public:
            RichardsonEqn(Real fh, Real ft, Real fs, Real t, Real s) : fdelta_h_(fh), ft_(ft), fs_(fs), t_(t), s_(s) {}
    ...
    RichardsonExtrapolation::RichardsonExtrapolation(const std::function<Real(Real)>& f, Real delta_h, Real n)
    : delta_h_(delta_h), fdelta_h_(f(delta_h)), n_(n), f_(f)
    {
    }
    ...
    Real RichardsonExtrapolation::operator()(Real t, Real s) const
    {
