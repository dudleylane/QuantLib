...
namespace QuantLib
{
    ...
    Real CumulativeStudentDistribution::operator()(Real x) const
    {
        ...
        return 0.5 +
               0.5 * sig * (incompleteBetaFunction(0.5 * n_, 0.5, 1.0) - incompleteBetaFunction(0.5 * n_, 0.5, xx));
    }
    ...
    Real InverseCumulativeStudent::operator()(Real y) const
    {
        ...
        QL_REQUIRE(count < maxIterations_, "maximum number of iterations " << maxIterations_
