...
namespace QuantLib
{
    ...
    BivariateCumulativeStudentDistribution::BivariateCumulativeStudentDistribution(Natural n, Real rho)
    : n_(n), rho_(rho)
    {
    }

    Real BivariateCumulativeStudentDistribution::operator()(Real x, Real y) const
    {
