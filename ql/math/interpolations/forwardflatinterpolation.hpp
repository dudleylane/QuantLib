...
namespace QuantLib
{
    ...
    */
      ...
      public:
        ...
        ForwardFlatInterpolation(const I1& xBegin, const I1& xEnd, const I2& yBegin)
        {
            impl_ = ext::shared_ptr<Interpolation::Impl>(
                new detail::ForwardFlatInterpolationImpl<I1, I2>(xBegin, xEnd, yBegin));
            impl_->update();
        }
    };
    ...
    namespace detail
    {
        ...
        template <class I1, class I2>
        class ForwardFlatInterpolationImpl final : public Interpolation::templateImpl<I1, I2>
        {
          public:
            ForwardFlatInterpolationImpl(const I1& xBegin, const I1& xEnd, const I2& yBegin)
            : Interpolation::templateImpl<I1, I2>(xBegin, xEnd, yBegin, ForwardFlat::requiredPoints),
