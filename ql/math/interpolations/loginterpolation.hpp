...
namespace QuantLib
{
    ...
    */
    class LogLinearInterpolation : public Interpolation
    {
      public:
        ...
        {
            impl_ = ext::make_shared<detail::LogInterpolationImpl<I1, I2>>(xBegin, xEnd, yBegin, Linear());
            impl_->update();
        }
    };
      ...
      public:
                              ...
                              Real rightConditionValue)
        {
            impl_ = ext::make_shared<detail::LogInterpolationImpl<I1, I2>>(
                xBegin, xEnd, yBegin, Cubic(da, monotonic, leftC, leftConditionValue, rightC, rightConditionValue));
            impl_->update();
        }
    };
    ...
    class LogCubic
    {
      public:
        ...
        Interpolation interpolate(const I1& xBegin, const I1& xEnd, const I2& yBegin) const
        {
            return LogCubicInterpolation(xBegin, xEnd, yBegin, da_, monotonic_, leftType_, leftValue_, rightType_,
                                         rightValue_);
        }
    ...
    */
    ...
    class LogMixedLinearCubicInterpolation : public Interpolation
    {
      public:
                                         ...
                                         Real rightConditionValue)
        {
            impl_ = ext::make_shared<detail::LogInterpolationImpl<I1, I2>>(
                xBegin, xEnd, yBegin,
                MixedLinearCubic(n, behavior, da, monotonic, leftC, leftConditionValue, rightC, rightConditionValue));
            impl_->update();
        }
    };
    ...
    class LogMixedLinearCubic
    {
      public:
        ...
        Interpolation interpolate(const I1& xBegin, const I1& xEnd, const I2& yBegin) const
        {
            return LogMixedLinearCubicInterpolation(xBegin, xEnd, yBegin, n_, behavior_, da_, monotonic_, leftType_,
    ...
    */
    ...
    namespace detail
    {
        ...
        template <class I1, class I2>
        class LogInterpolationImpl final : public Interpolation::templateImpl<I1, I2>
        {
          public:
            template <class Interpolator>
            LogInterpolationImpl(const I1& xBegin, const I1& xEnd, const I2& yBegin, const Interpolator& factory)
            : Interpolation::templateImpl<I1, I2>(xBegin, xEnd, yBegin, Interpolator::requiredPoints),
              logY_(xEnd - xBegin)
            {
            ...
            void update() override
            {
                ...
                {
                    QL_REQUIRE(this->yBegin_[i] > 0.0, "invalid value (" << this->yBegin_[i] << ") at index " << i);
                    logY_[i] = std::log(this->yBegin_[i]);
                }
                interpolation_.update();
            }
            Real value(Real x) const override { return std::exp(interpolation_(x, true)); }
            Real primitive(Real) const override { QL_FAIL("LogInterpolation primitive not implemented"); }
            Real derivative(Real x) const override { return value(x) * interpolation_.derivative(x, true); }
