...
namespace QuantLib
{
    ...
    */
      ...
      public:
        ...
        BackwardFlatInterpolation(const I1& xBegin, const I1& xEnd, const I2& yBegin)
        {
            impl_ = ext::shared_ptr<Interpolation::Impl>(
                new detail::BackwardFlatInterpolationImpl<I1, I2>(xBegin, xEnd, yBegin));
            impl_->update();
        }
    };
    ...
    namespace detail
    {
        ...
        template <class I1, class I2>
        class BackwardFlatInterpolationImpl final : public Interpolation::templateImpl<I1, I2>
        {
          public:
            BackwardFlatInterpolationImpl(const I1& xBegin, const I1& xEnd, const I2& yBegin)
            : Interpolation::templateImpl<I1, I2>(xBegin, xEnd, yBegin, BackwardFlat::requiredPoints),
