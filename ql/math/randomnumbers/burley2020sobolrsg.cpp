...
namespace QuantLib
{
    ...
    namespace
    {
        ...
        const std::uint8_t bitReverseTable[] = {
            0U,   128U, 64U,  192U, 32U,  160U, 96U,  224U, 16U,  144U, 80U,  208U, 48U,  176U, 112U, 240U, 8U,   136U,
            72U,  200U, 40U,  168U, 104U, 232U, 24U,  152U, 88U,  216U, 56U,  184U, 120U, 248U, 4U,   132U, 68U,  196U,
            36U,  164U, 100U, 228U, 20U,  148U, 84U,  212U, 52U,  180U, 116U, 244U, 12U,  140U, 76U,  204U, 44U,  172U,
            108U, 236U, 28U,  156U, 92U,  220U, 60U,  188U, 124U, 252U, 2U,   130U, 66U,  194U, 34U,  162U, 98U,  226U,
            18U,  146U, 82U,  210U, 50U,  178U, 114U, 242U, 10U,  138U, 74U,  202U, 42U,  170U, 106U, 234U, 26U,  154U,
            90U,  218U, 58U,  186U, 122U, 250U, 6U,   134U, 70U,  198U, 38U,  166U, 102U, 230U, 22U,  150U, 86U,  214U,
            54U,  182U, 118U, 246U, 14U,  142U, 78U,  206U, 46U,  174U, 110U, 238U, 30U,  158U, 94U,  222U, 62U,  190U,
            126U, 254U, 1U,   129U, 65U,  193U, 33U,  161U, 97U,  225U, 17U,  145U, 81U,  209U, 49U,  177U, 113U, 241U,
            9U,   137U, 73U,  201U, 41U,  169U, 105U, 233U, 25U,  153U, 89U,  217U, 57U,  185U, 121U, 249U, 5U,   133U,
            69U,  197U, 37U,  165U, 101U, 229U, 21U,  149U, 85U,  213U, 53U,  181U, 117U, 245U, 13U,  141U, 77U,  205U,
            45U,  173U, 109U, 237U, 29U,  157U, 93U,  221U, 61U,  189U, 125U, 253U, 3U,   131U, 67U,  195U, 35U,  163U,
            99U,  227U, 19U,  147U, 83U,  211U, 51U,  179U, 115U, 243U, 11U,  139U, 75U,  203U, 43U,  171U, 107U, 235U,
            27U,  155U, 91U,  219U, 59U,  187U, 123U, 251U, 7U,   135U, 71U,  199U, 39U,  167U, 103U, 231U, 23U,  151U,
            87U,  215U, 55U,  183U, 119U, 247U, 15U,  143U, 79U,  207U, 47U,  175U, 111U, 239U, 31U,  159U, 95U,  223U,
            63U,  191U, 127U, 255U};
    ...
    const std::vector<std::uint32_t>& Burley2020SobolRsg::nextInt32Sequence() const
    {
        ...
        do
        {
            ...
            for (Size g = 0; g < 4 && i < dimensionality_; ++g, ++i)
            {
                ...
                integerSequence_[i] = nested_uniform_scramble(integerSequence_[i], static_cast<std::uint32_t>(seed));
            }
        } while (i < dimensionality_);
        QL_REQUIRE(++nextSequenceCounter_ != 0, "Burley2020SobolRsg::nextInt32Sequence(): period exceeded");
        return integerSequence_;
    }
