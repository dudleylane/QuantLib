...
namespace QuantLib
{
    ...
    class ConstantParameter : public Parameter
    {
      ...
      public:
        ...
        : Parameter(1, ext::shared_ptr<Parameter::Impl>(new ConstantParameter::Impl), constraint)
        {
        }
    ...
    class NullParameter : public Parameter
    {
      ...
      public:
        NullParameter() : Parameter(0, ext::shared_ptr<Parameter::Impl>(new NullParameter::Impl), NoConstraint()) {}
    };
    ...
    class PiecewiseConstantParameter : public Parameter
    {
      ...
      public:
        ...
        : Parameter(times.size() + 1,
                    ext::shared_ptr<Parameter::Impl>(new PiecewiseConstantParameter::Impl(times)),
                    constraint)
        {
        }
    };
      ...
      public:
        class NumericalImpl : public Parameter::Impl
        {
          public:
            ...
            void change(Real x) { values_.back() = x; }
            void reset()
            {
                times_.clear();
                values_.clear();
        ...
        TermStructureFittingParameter(const ext::shared_ptr<Parameter::Impl>& impl) : Parameter(0, impl, NoConstraint())
        {
        }

        TermStructureFittingParameter(const Handle<YieldTermStructure>& term)
        : Parameter(0, ext::shared_ptr<Parameter::Impl>(new NumericalImpl(term)), NoConstraint())
        {
        }
    };
