...
namespace QuantLib
{
    ...
    bool CallSpecifiedPathwiseMultiProduct::nextTimeStep(const CurveState& currentState,
    ...
    std::unique_ptr<MarketModelPathwiseMultiProduct> CallSpecifiedPathwiseMultiProduct::clone() const
    {
