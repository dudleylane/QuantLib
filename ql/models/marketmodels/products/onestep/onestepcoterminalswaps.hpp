...
namespace QuantLib
{
    ...
    inline std::vector<Time> OneStepCoterminalSwaps::possibleCashFlowTimes() const
    {
    ...
    inline Size OneStepCoterminalSwaps::maxNumberOfCashFlowsPerProductPerStep() const
    {
        return 2 * lastIndex_;
    }
