...
namespace QuantLib
{
    ...
    inline std::vector<Time> MultiStepCoterminalSwaps::possibleCashFlowTimes() const
    {
    ...
    inline Size MultiStepCoterminalSwaps::maxNumberOfCashFlowsPerProductPerStep() const
    {
        return 2;
    }
