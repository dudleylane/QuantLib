...
namespace QuantLib
{
    ...
    inline std::vector<Time> MultiStepCoinitialSwaps::possibleCashFlowTimes() const
    {
    ...
    inline Size MultiStepCoinitialSwaps::maxNumberOfCashFlowsPerProductPerStep() const
    {
        return 2;
    }
