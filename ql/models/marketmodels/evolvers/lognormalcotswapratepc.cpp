...
namespace QuantLib
{
    ...
    LogNormalCotSwapRatePc::LogNormalCotSwapRatePc(const ext::shared_ptr<MarketModel>& marketModel,
    ...
    : marketModel_(marketModel), numeraires_(numeraires), initialStep_(initialStep),
      ...
      curveState_(marketModel->evolution().rateTimes()), swapRates_(marketModel->initialRates()),
