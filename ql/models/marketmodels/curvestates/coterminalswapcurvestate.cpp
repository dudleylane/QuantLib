...
namespace QuantLib
{
    ...
    void CoterminalSwapCurveState::setOnCoterminalSwapRates(const std::vector<Rate>& rates, Size firstValidIndex)
    {
        ...
        std::copy(rates.begin() + first_, rates.end(), cotSwapRates_.begin() + first_);
    ...
    Rate CoterminalSwapCurveState::coterminalSwapAnnuity(Size numeraire, Size i) const
    {
        QL_REQUIRE(first_ < numberOfRates_, "curve state not initialized yet");
    ...
    Rate CoterminalSwapCurveState::cmSwapAnnuity(Size numeraire, Size i, Size spanningForwards) const
    {
        QL_REQUIRE(first_ < numberOfRates_, "curve state not initialized yet");
        QL_REQUIRE(numeraire >= first_ && numeraire <= numberOfRates_, "invalid numeraire");
        QL_REQUIRE(i >= first_ && i <= numberOfRates_, "invalid index");
    ...
    Rate CoterminalSwapCurveState::cmSwapRate(Size i, Size spanningForwards) const
    {
        QL_REQUIRE(first_ < numberOfRates_, "curve state not initialized yet");
        QL_REQUIRE(i >= first_ && i <= numberOfRates_, "invalid index");
    ...
    std::unique_ptr<CurveState> CoterminalSwapCurveState::clone() const
    {
