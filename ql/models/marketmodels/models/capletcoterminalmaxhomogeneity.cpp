...
namespace QuantLib
{
    ...
    namespace
    {
        ...
        bool singleRateClosestPointFinder(Size capletNumber,
                                          ...
                                          Real& capletError)
        {
            ...
            Real thisSwapVariance = 0.0;
            {
                ...
                {
                    previousSwapVariance += previousRateSolution[i] * previousRateSolution[i];
            ...
            SphereCylinderOptimizer optimizer(R, S, alpha, movedTarget[0], movedTarget[1],
                                              movedTarget[movedTarget.size() - 1], finalWeight);
            ...
            else
            {
                ...
                {
                    optimizer.findClosest(maxIterations, tolerance, Z1, Z2, Z3);
                }
                else
            ...
            Array arraySolution(transpose(orthTransformation) * rotatedSolution);
            {
                Size i = 0;
      ...
      caplet0Swaption1Priority_(caplet0Swaption1Priority)
    {
        ...
        QL_REQUIRE(caplet0Swaption1Priority >= 0.0 && caplet0Swaption1Priority <= 1.0,
        ...
        std::vector<Matrix>& swapCovariancePseudoRoots)
    {
        ...
        for (Size i = 0; i < numberOfRates - 1; ++i)
        {
            ...
            bool success = singleRateClosestPointFinder(
                i, secondRateVols, firstRateVols, targetCapletVariance, correlations, w0, w1, caplet0Swaption1Priority,
                maxIterations, tolerance, theseNewVols, thisFinalWeight, thisSwaptionError, thisCapletError);
    ...
    Natural CTSMMCapletMaxHomogeneityCalibration::calibrationImpl_(Natural numberOfFactors,
                                                                   Natural maxIterations,
                                                                   Real tolerance)
    {

        return capletMaxHomogeneityCalibration(evolution_, *corr_, displacedSwapVariances_,
                                               ...
                                               deformationSize_, totalSwaptionError_,
