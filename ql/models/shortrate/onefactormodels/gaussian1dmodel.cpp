...
namespace QuantLib
{
                                   ...
                                   const ext::shared_ptr<SwapIndex>& swapIdx) const
    {
        ...
        Handle<YieldTermStructure> ytsd = swapIdx->discountingTermStructure(); // either might be empty, then
                                                                               // use model curve
                                      ...
                                      const ext::shared_ptr<SwapIndex>& swapIdx) const
    {
        ...
        Handle<YieldTermStructure> ytsd = swapIdx->discountingTermStructure(); // might be empty, then use
                                                                               // model curve
    ...
    Real Gaussian1dModel::zerobondOption(const Option::Type& type,
                                         const Date& expiry,
    ...
    Real Gaussian1dModel::gaussianPolynomialIntegral(
        const Real a, const Real b, const Real c, const Real d, const Real e, const Real y0, const Real y1)
    {
    ...
    Real Gaussian1dModel::gaussianShiftedPolynomialIntegral(const Real a,
                                                            const Real b,
                                                            const Real c,
                                                            const Real d,
                                                            const Real e,
    ...
    Array
    Gaussian1dModel::yGrid(const Real stdDevs, const int gridPoints, const Real T, const Real t, const Real y) const
    {
