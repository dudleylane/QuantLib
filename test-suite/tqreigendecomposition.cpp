...
BOOST_AUTO_TEST_CASE(testEigenValueDecomposition)
{
    ...
    diag[3] = 2;
    diag[4] = 0;
    Real ev[5] = {11.2467832217139119, 7.4854967362908535, 5.5251516080277518, 2.1811760273123308, -0.4386075933448487};

    TqrEigenDecomposition tqre(diag, sub, TqrEigenDecomposition::WithoutEigenVector);
...
BOOST_AUTO_TEST_CASE(testEigenVectorDecomposition)
{
    ...
    if (std::fabs(0.25 + tqre.eigenvectors()[0][0] * tqre.eigenvectors()[0][1] * tqre.eigenvectors()[1][0] *
